...
-- ddl-end --
COMMENT ON COLUMN evaluacion_inscripcion.requisito.activo IS 'Flag que indica si el criterio de admisión esta activo o no';
-- ddl-end --
COMMENT ON COLUMN evaluacion_inscripcion.requisito.numero_orden IS 'Número de orden en el que se deben mostrar los criterios de admisión';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN evaluacion_inscripcion.tipo_entrevista.descripcion IS 'Descripción del tipo de entrevista';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN evaluacion_inscripcion.tipo_entrevista.fecha_modificacion IS 'Fecha de la última modificación del registro';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN evaluacion_inscripcion.entrevistador.fecha_modificacion IS 'Fecha de la última modificación del registro';
-- ddl-end --
...
CREATE TABLE evaluacion_inscripcion.requisito_programa_academico (
	...
	CONSTRAINT uq_requisito_programa_periodo UNIQUE (programa_academico_id, periodo_id, requisito_id)
...
-- ddl-end --
COMMENT ON COLUMN evaluacion_inscripcion.requisito_programa_academico.porcentaje IS 'Porcentaje o peso del criterio de admisión para el proyecto.';
-- ddl-end --
